...
public class EBMakePaymentPage extends AppiumBaseDriver{
	...
	@AndroidFindBy(id = "sendPaymentButton")
	//@iOSXCUITFindBy(accessibility = "Enter check amount")
	private WebElement currentTotals;
	...
	public void proceedWithPayment() {
 	...
 	public void verifyNewBalance(double amountSent){
		String newBalance =new DecimalFormat("#.00").format(100 - amountSent);
		driver.findElement(new MobileBy.ByAndroidUIAutomator("new UiSelector().textContains(\"Your balance is: "+newBalance+"$\")"));
	}
}
